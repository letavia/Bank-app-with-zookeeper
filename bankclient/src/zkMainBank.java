  ...
  public zkMainBank(ZooKeeper zk, zkBank bank) 
  {
    ...
    while (!exit) {
      try {
        ...
        switch (menuKey) {
        case 1:
          zkClient input = readClient(sc);
          if (input != null) {	
             bank.createClient(zk, input); }
          else System.out.println("Account is not created. Data provided is not correct");
          break;
        case 2:
          System.out.print(">>> Enter account number (int) = ");
          if (sc.hasNextInt()) {
          ...
          if (sc.hasNextInt()) {
            ...
            if (sc.hasNextInt()) {
              ...
              bank.updateClient(zk, accNumber, balance);
                ...
                System.out.println("The text provided is not an integer");
                System.out.println("Account is not updated. Data provided is not correct");
                sc.next();
            } 
          } else {
                System.out.println("The text provided is not an integer");
        ...
        case 4:
          ...
          if (sc.hasNextInt()) {
            ...
            System.out.println("The text provided is not an integer");
            System.out.println("Account is not deleted. Data provided is not correct");
            sc.next();
          }
          break;
        case 5:
